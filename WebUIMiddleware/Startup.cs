...
namespace WebUIMiddleware
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //app.Map("/v1", RequestMiddlewareTest);
        ...
        private static void RequestMiddlewareTest(IApplicationBuilder app)
        {
            app.Run(async context =>
            {
                var queryDictionary = Microsoft.AspNetCore.WebUtilities.QueryHelpers.ParseQuery(context.Request.QueryString.ToString());

                await context.Response.WriteAsync("This is Request Middleware running by /");
            });
        }
    }
}
